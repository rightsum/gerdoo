...
| [024](024-2026-09-19-the-wake-word-was-working-the-whole-time.md) | 2026-09-19 | Ten shouts and no answer — the first one woke it, the music it never paused drowned the reply, and the echo canceller that was blamed measured 38.5 dB | ✅ Fixed and deployed · 🔄 Barge-in unmeasured |
| [025](025-2026-09-19-the-speaker-drowns-the-wake-word.md) | 2026-09-19 | At 90% the music masks the voice at the microphone itself — proven on the raw uncancelled mic — plus a touch "Wake!" button, and a window manager that will not let it show over video | ✅ Cause proven · 🔄 Touch fallback built · ❌ Wake at volume unsolved |
